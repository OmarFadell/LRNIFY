...
function CoursePageHeaderUnpaid() {
    ...
    return (
        <div className='headera'>
            ...
            <Stack
                ...
                <p style={{marginTop:-30,fontSize:30,marginRight:800}} >{courseOutline}</p>
            ...
            <Stack
                    ...
                    >
                        ...
                        <Box>  <h2 style={{fontSize:50,fontWeight:400}} ><PaymentsIcon sx={{fontSize:40}}/> {currency.substring(1,2)} {price*mult} </h2>
                        <h3 style={{marginTop:-40,fontWeight:400,fontSize:25,color:'black',textAlign:'center'}}>Discount: {promo}% </h3> </Box>
...
export default CoursePageHeaderUnpaid
