...
function InstructorNavbar() {
  ...
  useEffect(() => {
        ...
        axios.get(`http://localhost:4000/api/instructor/getInstructorbyId?instructorId=${creds.substring(1,25)}`).then(res => {
        ...
        <nav className='navbar'>
          ...
          {/* <FormHelperText id="outlined-weight-helper-text">Weight</FormHelperText> */}
                ...
                <li style={{marginTop:28}}>
                  ...
                  <li className='nav-item'>
                  <Link to = '/' className='nav-links' onClick={(e) => window.location.href=`/inspg?instructorId=${creds.substring(1,25)}`}>
